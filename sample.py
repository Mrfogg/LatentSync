...
# 使用示例
source_folder = "/media/qc/1/high_visual_quality"  # 源文件夹路径
train_folder = "/media/qc/1/high_visual_quality/train"  # 训练文件夹路径
val_folder = "/media/qc/1/high_visual_quality/val"  # 验证文件夹路径
